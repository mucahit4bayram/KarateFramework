...
[
  {
    ...
    "experience": [
      ...
      * match response == expected
      ...
      # yukarıdaki kullanıcı verileri bizim API deki get alluser deki kullanıcıların hepsi.
      # biz hemen üstte yaptığımız işlemlede statuc code, response ve request ti karşılatrıyoruz.
  ...
  Scenario: Query Params
    ...
    * method GET
    * status 200
#  * print response  (istersek yazdırabiliriz ancak çok yer kaplıyor yazdırmadık )
...
#  Verify response body
    ...
    # Verify each id  ( tamamının id si number mi? )
